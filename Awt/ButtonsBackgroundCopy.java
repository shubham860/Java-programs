...
class ButtonsBackgroundCopy extends Frame implements ActionListener
{
  Button b1,b2,b3;

ButtonsBackgroundCopy()
{
  this.setLayout(new FlowLayout());//set layout by ourselves
 ...
 public static void main(String[] args)
  {
    ...
    ButtonsBackgroundCopy b = new ButtonsBackgroundCopy();
